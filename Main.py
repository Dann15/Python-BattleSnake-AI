...
def main():
	print("starting")
	game = Game(board_size=10, starting_apples=0, starting_pos_x=3, starting_pos_y=3, starting_length=3)
	print(game)
	# uncomment if you want to play yourself by spamming wasd and enter
	# while True:
	# 	button = input("wasd")
	# 	print(button)
	# 	if button == "w":
...
class Game:
	def __init__(self, board_size, starting_apples=5, starting_pos_x=3, starting_pos_y=3, starting_length=3):
		...
		self.apple_list = []
		self.update_game()
		while len(self.apple_list) < starting_apples:
